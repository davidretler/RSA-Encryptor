\documentclass[landscape,a0paper,fontscale=.46]{baposter} % Adjust the font scale/size here
...
\begin{posterbox}[name=rsa,column=1,row=0,span=2]{RSA Algorithm} % This block's bottom aligns with the bottom of the conclusion block
